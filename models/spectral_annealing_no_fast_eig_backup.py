...
class SpectralAnnealingV2:
        ...
        if self.alpha is None:
            ...
            for alpha in alpha_list:
                try:
                    ...
                    evals, evecs, evecs_y = self._solve_eigenvalue_problem(J_csr, D_vec, beta, k=1)
                    ...
                    if self.use_local_search:
                        spins_hash = hash(tuple(cp.asnumpy(spins).astype(int)))
            ...
            if self.use_local_search and unique_solutions:
                ...
                if len(spins_list) > 0:
                    ...
                    for i, solution_hash in enumerate(solution_hashes):
                        ...
                        improved_spins = cp.sign(refined_spins_batch[:, i].astype(cp.float64))
    ...
    def _solve_eigenvalue_problem(self, J_csr, D_vec, beta, k=1):  
        n = D_vec.size
